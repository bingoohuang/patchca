...
public class RandomSystemFontFactory implements FontFactory {
    protected List<String> families;
    protected int minSize;
    protected int maxSize;
    protected boolean randomStyle;

    public RandomSystemFontFactory() {
    ...
    public RandomSystemFontFactory(List<String> families) {
        this();
        this.families = families;
    }

    public RandomSystemFontFactory(String[] families) {
        this();
        this.families = Arrays.asList(families);
    }

    public RandomSystemFontFactory(int size, List<String> families) {
        this(families);
        minSize = maxSize = size;
    }

    public RandomSystemFontFactory(int size, String[] families) {
        this(families);
        minSize = maxSize = size;
    }
